...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/Users/mikefinneran/.local/share/claude/versions/2.0.25 --ripgrep'
fi
export PATH=/opt/homebrew/bin\:/opt/homebrew/sbin\:/Users/mikefinneran/.local/bin\:/usr/local/bin\:/System/Cryptexes/App/usr/bin\:/usr/bin\:/bin\:/usr/sbin\:/sbin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin\:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin
